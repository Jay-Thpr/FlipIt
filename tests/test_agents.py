        ...
        "input": {
            ...
            "previous_outputs": {
                "depop_search": {
                    ...
                    "results": [{"platform": "depop", "title": "Sample listing", "price": 40.0, "url": "https://depop.example/listing-1", "condition": "good"}],
                }
            },
        },
        "context": {"request_metadata": {"source": "contract-test"}, "pipeline_input": {"query": "Nike vintage tee size M", "budget": 45}},
        ...
        "input": {
            ...
            "previous_outputs": {
                ...
                "ebay_search": {
                    ...
                    "results": [{"platform": "ebay", "title": "Sample listing", "price": 38.0, "url": "https://ebay.example/listing-1", "condition": "good"}],
                },
            },
        },
        "context": {"request_metadata": {"source": "contract-test"}, "pipeline_input": {"query": "Nike vintage tee size M", "budget": 45}},
        ...
        "input": {
            ...
            "previous_outputs": {
                ...
                "mercari_search": {
                    ...
                    "results": [{"platform": "mercari", "title": "Sample listing", "price": 37.0, "url": "https://mercari.example/listing-1", "condition": "good"}],
                },
            },
        },
        "context": {"request_metadata": {"source": "contract-test"}, "pipeline_input": {"query": "Nike vintage tee size M", "budget": 45}},
        ...
        "input": {
            ...
            "previous_outputs": {
                ...
                "offerup_search": {
                    ...
                    "results": [{"platform": "offerup", "title": "Sample listing", "price": 36.0, "url": "https://offerup.example/listing-1", "condition": "good"}],
                },
            },
        },
        "context": {"request_metadata": {"source": "contract-test"}, "pipeline_input": {"query": "Nike vintage tee size M", "budget": 45}},
